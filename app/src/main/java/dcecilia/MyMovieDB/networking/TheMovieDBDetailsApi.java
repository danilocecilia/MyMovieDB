...
public class TheMovieDBDetailsApi {
    private static final String TAG = TheMovieDBDetailsApi.class.getName();
     ...
     * @param apiKey
     */
    public TheMovieDBDetailsApi(String apiKey) {
        this.apiKey = apiKey;
    }
    ...
    private String getUrl(int id) {
        return BASE_API_URL + id + "?api_key=" + apiKey + "&append_to_response=credits,trailers" + "&language=pt";
    }
}
